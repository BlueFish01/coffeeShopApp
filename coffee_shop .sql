...
--
-- Host: db
-- Generation Time: Nov 24, 2022 at 11:36 PM
...
(12, 24, 1, 'Hot', 'small', 'noSugar', 2, '', '฿ 70'),
(13, 25, 1, 'Iced', 'regular', '2xSugar', 1, '', '฿ 50');
...
(24, 9, 70, 0, '2022-11-24 13:40:20'),
(25, 9, 125, 0, '2022-11-24 14:30:10');
...
(1, 'Espresso', 'Smooth, nutty, sweet, yet heavy-bodlied espresso.', 35, 1, 'menu/espresso.jpg', 'Espresso'),
...
(8, 'Cold brew tonic', 'Fresh organic cold brew coffee with tonic.', 60, 1, 'menu/cbtonic.jpg', 'Espresso');
...
--
ALTER TABLE `drinkList`
  MODIFY `drinkID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
